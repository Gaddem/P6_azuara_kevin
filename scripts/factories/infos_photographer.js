...
async function infosPhotographer(resPhotographer, id_photographer) {
  ...
  async function displayDataPhotographer(arrayDataInfo) {
    ...
    let src_temp = arrayDataInfo.portrait.slice(4);
  ...
  function displayDataPhotographer(arrayDataInfo) {
    const info_location = document.querySelector(".photograph_txt");
    const photo_location = document.querySelector(".photograph_photo");
  ...
  displayDataPhotographer(resPhotographer);
